...
//		}
	...
	class NavigationPanel extends JPanel implements MouseListener {
		...
		private void setComponentsLocation() {
			currentPanelLabel.setBounds((int) (NUMBER.px*50),
					(NUMBER.NAVIGATION_PANEL_HEIGHT - (int) (NUMBER.px * 100)) / 2, (int) (NUMBER.px * 200), (int) (NUMBER.px * 100));
			teamPanelButton.setBounds((int) (NUMBER.px * 340), (int) (NUMBER.px * 17), (int) (NUMBER.px * 160), (int) (NUMBER.px * 50));
			playerPanelButton.setBounds((int) (NUMBER.px * 520), (int) (NUMBER.px * 17), (int) (NUMBER.px * 160), (int) (NUMBER.px * 50));
			quitSystem.setBounds((int) (NUMBER.px * 700), (int) (NUMBER.px * 17), (int) (NUMBER.px * 160), (int) (NUMBER.px * 50));
