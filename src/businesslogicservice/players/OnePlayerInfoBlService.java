...
public interface OnePlayerInfoBlService {
	...
	public PlayerNormalInfo getPlayerNormalInfo_avg(String playerName);// 根据球员名称得到场均普通比赛数据

	public PlayerNormalInfo getPlayerNormalInfo_tot(String playerName);// 根据球员名称得到总和普通比赛数据

	public PlayerHighInfo getPlayerHighInfo(String playerName);// 根据球员名称得到高级比赛数据

	public PlayerPerformOfOneMatch[] getPlayerPerform(String playerName);// 根据球员名称得到所有比赛信息
}
