...
public class StringToEnum {
	...
	public static boolean isPlayerPositionEqual(PlayerPosition standPosition, PlayerPosition selectedPosition) {
	 ...
	 public static PerformanceOfPlayer toPerformanceOfPlayer(String str){
			...
			case "所属球队":return PerformanceOfPlayer.TeamName;
			case "总篮板":
			...
			case "投篮命中率":return PerformanceOfPlayer.TotalHitRate;
			case "三分命中率":return PerformanceOfPlayer.ThreePointHitRate;
			case "罚球命中率":return PerformanceOfPlayer.FreePointHitRate;
			case "参赛场数":return PerformanceOfPlayer.MatchNumber;
			case "先发场数":return PerformanceOfPlayer.FirstNumber;
			case "总在场时间":
				return PerformanceOfPlayer.TotalPlayingTime;
			case "场均在场时间":
				return PerformanceOfPlayer.AveragePlayingTime;
			case "效率值":return PerformanceOfPlayer.CommonEfficiency;
			case "Gmsc效率值":return PerformanceOfPlayer.GmScEfficiency;
			case "使用率":return PerformanceOfPlayer.UseRate;
			case "真实命中率":return PerformanceOfPlayer.RealHitRate;
			case "投篮效率":return PerformanceOfPlayer.ShootEfficiency;
			case "助攻率":return PerformanceOfPlayer.AssistRate;
			case "进攻篮板":return PerformanceOfPlayer.AverageOffensiveReboundNumber;
			case "防守篮板":return PerformanceOfPlayer.AverageDefensiveReboundNumber;
			case "篮板率":return PerformanceOfPlayer.ReboundEfficiency;
			case "进攻篮板率":return PerformanceOfPlayer.OffensiveReboundRate;
			case "防守篮板率":return PerformanceOfPlayer.DefensiveReboundRate;
			case "盖帽率":return PerformanceOfPlayer.BlockRate;
			case "抢断率":return PerformanceOfPlayer.StealRate;
			case "失误率":return PerformanceOfPlayer.TurnoverRate;
			case "两双次数":return PerformanceOfPlayer.DoubleDouble;
			case "三双次数":return PerformanceOfPlayer.TripleDouble;
			}
		return null;
	 }
