...
public class NUMBER {
	...
	public static final int NAVIGATION_PANEL_WIDTH = NUMBER.FRAME_WIDTH;
	public static final int NAVIGATION_PANEL_HEIGHT = NUMBER.FRAME_HEIGHT / 10;
	public static final int DETAIL_PANEL_WIDTH = NUMBER.FRAME_WIDTH / 9 * 2;
	public static final int DETAIL_PANEL_HEIGHT = NUMBER.FRAME_HEIGHT - NUMBER.FRAME_HEIGHT / 10;
